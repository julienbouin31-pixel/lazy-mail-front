    ...
    <div class="w-full max-w-md bg-white border border-gray-200 p-8 rounded-xl shadow-sm">
      ...
      <form @submit.prevent="handleLogin" class="space-y-4">
        <div>
          ...
          <input
            ...
            :class="error ? 'border-red-300 focus:ring-1 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-1 focus:ring-black focus:border-black'"
            required
          />
        </div>
      ...
      <div v-if="isFromExtension" class="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
        <p class="text-xs text-blue-700 text-center">
          Connexion depuis l'extension LazyMail
        </p>
      </div>
